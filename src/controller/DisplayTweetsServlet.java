...
/**
 * Servlet implementation class DisplayTweetServlet
 */
@WebServlet("/DisplayTweetsServlet")
public class DisplayTweetsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			getServletContext().getRequestDispatcher("/tweets/TempDisplayTweets.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
