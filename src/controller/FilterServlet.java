...
public class FilterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			//set menu in header
			menu = "<li class=\"active\"><a href=\"/TwitterAggregator2/Filter\">Filters</a></li>"
			...
			getServletContext().getRequestDispatcher("/filter/TempFilter.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
